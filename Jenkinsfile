...
podTemplate(
  ...
  containers:[
    ...
    containerTemplate(name: 'jnlp', image: 'us.gcr.master.openx.org/ox-registry/jenkins-agent-java:centos7', alwaysPullImage 'true', workingDir: '/var/lib/jenkins-agent', command: '/etc/init.d/jenkins-agent', args: 'start'),
  ]
)
