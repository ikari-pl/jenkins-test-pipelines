...
podTemplate(
  ...
  containers:[
    ...
    containerTemplate(name: 'jnlp', image: 'us.gcr.master.openx.org/ox-registry/jenkins-agent-base:centos7', workingDir: '/var/lib/jenkins-agent', command: '/etc/init.d/jenkins-agent', args: 'start'),
  ]
)
