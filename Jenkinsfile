...
podTemplate(
  ...
  containers:[
    ...
    containerTemplate(name: 'jnlp', image: 'us.gcr.master.openx.org/ox-registry/jenkins-agent-java:centos7', workingDir: '/var/lib/jenkins', command: '/etc/init.d/jenkins-agent', args: 'start'),
  ]
)
